...
Итог, читаемый по сетевой трассе: атакующий полностью перехватывает и модифицирует сетевые пакеты, после атаки видно общение attacker-receiver. ![alt text](receiver-arp.png)
